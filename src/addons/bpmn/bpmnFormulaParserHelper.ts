...
export class BpmnFormulaParserHelper {
    ...
    public getFormulaDisplayValue(elementCaptions: Record<string, string>, parameterMappings: Record<string, ParameterMapping>, elementParameters: Record<string, ProcessElement>): string {
